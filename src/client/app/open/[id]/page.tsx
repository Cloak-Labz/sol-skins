...
import { ArrowLeft, Package, Coins, Loader2 } from "lucide-react"
          ...
          <div className="space-y-8">
            ...
            <div className="relative overflow-hidden bg-card rounded-xl border border-accent/30 p-8">
              ...
              <div className="relative h-32 overflow-hidden rounded-lg border border-border">
                ...
                >
                  {lootBox.possibleSkins && [...lootBox.possibleSkins, ...lootBox.possibleSkins, ...lootBox.possibleSkins].map((skin, index) => (
                    <div
                      key={index}
                    ...
                    >
                      ...
                      <div className="text-xs text-center px-1">
                        ...
                        <div className="text-xs opacity-75">{skin.skinName}</div>
                      </div>
                    </div>
                  ))}
                </div>
