                ...
                <div className="flex items-center space-x-4">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center text-sm ${
                      activity.type === "case_opened" ? "bg-blue-500/20 text-blue-400" : "bg-green-500/20 text-green-400"
                    }`}
                  >
                  ...
                  <div>
                    <p className="text-white">
                      ...
                      <span className="font-medium">
                        {activity.skin ? `${activity.skin.weapon} | ${activity.skin.skinName}` : activity.lootBox?.name}
                      </span>
                    </p>
                    <p className="text-[#666] text-sm">{getTimeAgo(activity.timestamp)}</p>
                  </div>
                </div>
